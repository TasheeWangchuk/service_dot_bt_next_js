...
//     setExperiences((prev) => [...prev, { id: Date.now(), ...newExperience }]);
//   };
...
//     setCertifications((prev) => [...prev, { id: Date.now(), ...newCertification }]);
...
//             </button>
//           </div>
//           <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6"> {/* Portfolio Grid layout */}
