...
//         if (totalMilestoneAmount !== contractData.total_amount) {
//             setError(`Total milestone amounts (${totalMilestoneAmount}) must equal contract amount (${contractData.total_amount})`);
//             return false;
//         }
//         return true;
//     };
